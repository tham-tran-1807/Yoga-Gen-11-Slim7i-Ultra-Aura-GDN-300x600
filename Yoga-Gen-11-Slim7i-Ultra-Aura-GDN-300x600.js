...
lib.ssMetadata = [
		{name:"Yoga_Gen_11_Slim7i_Ultra_Aura_GDN_300x600_atlas_1", frames: [[0,1806,50,50],[0,0,300,600],[0,602,300,600],[0,1204,300,600],[302,0,300,600],[302,602,300,600],[302,1204,300,600],[604,0,300,600],[604,602,300,600]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["Yoga_Gen_11_Slim7i_Ultra_Aura_GDN_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.YogaGen11Slim7iUltraAuraGDN300x600 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(424).call(this.frame_424).wait(26));
	...
	this.timeline.addTween(cjs.Tween.get(this.btn_replay).wait(423).to({_off:false},0).wait(27));
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_mui_ten_xoay).wait(423).to({_off:false},0).to({y:11},12).wait(15));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(59).to({_off:false},0).to({_off:true},61).wait(330));

	// Frame_1
	this.instance_7 = new lib.Frame1();

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({_off:true},59).wait(391));
...
// library properties:
lib.properties = {
	id: '1FBB2D6DAF53DD499C824B7716196A74',
	width: 300,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Yoga_Gen_11_Slim7i_Ultra_Aura_GDN_300x600_atlas_1.png", id:"Yoga_Gen_11_Slim7i_Ultra_Aura_GDN_300x600_atlas_1"}
	],
	preloads: []
};
...
an.compositions['1FBB2D6DAF53DD499C824B7716196A74'] = {
